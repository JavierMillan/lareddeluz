...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    steps: [
      "Antes de escribir nada, respira tres minutos, con la exhalación más larga que la inhalación.",
      "Escribe la decisión en una frase y sin adornos.",
      "Separa en tres columnas: los hechos, lo que tú agregas y los riesgos reales o inventados.",
      "Responde qué haría tu súper tú viendo solo la primera y la tercera columna.",
      "Elige una cosa que harás hoy, en menos de cinco minutos.",
    ],
