...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Ve dónde te sirvió. Escribe tres momentos en los que esa creencia te protegió o te dio resultados. No la cargas por tonto; alguna vez funcionó.",
  ...
  },
  {
    ...
    needs: "Lo que notaste durante el día. Si anotaste algo, tenlo cerca.",
    steps: [
      "Vuelve a lo que notaste durante el día: lo que contestaste en automático cuando te agradecieron, te felicitaron, pediste algo o te equivocaste. Ahí es donde se esconden.",
  ...
  },
  {
    ...
    needs: "El video que grabaste y quince minutos. Nada más.",
    steps: [
      "Trae el video que grabaste sin ensayar. Si salió imperfecto, mejor: así es como hablas de verdad.",
      ...
      "Ahora mira solo el video, con el volumen en cero. Fíjate en tus manos, en tu postura y en tu cara. ¿Tu cuerpo dice lo mismo que estás diciendo?",
  ...
  },
  {
    ...
    needs: "Tu registro de la semana y dos minutos para revisarlo.",
    steps: [
      "Recorre tu registro. Anota cada actividad con su día y hora aproximada. No pongas «trabajo»: escribe la actividad concreta.",
      "Ahora clasifica lo que anotaste: lo que te drenó, lo neutro y lo que te recargó.",
      "Mira la semana completa. La pregunta no es cuánto te drenó, es si hubo algo que te recargara y cuándo.",
  ...
  },
  {
    ...
    needs: "Tu auditoría de energía y tu registro de dos semanas. Cinco minutos.",
    steps: [
      "Retoma la auditoría de energía y lo que registraste durante esas dos semanas.",
      ...
      "En el otro pon lo que drena y no devuelve nada. Sé honesto: esa reunión por compromiso, el grupo que te estresa o el proyecto que ya no quieres pero te da pena soltar.",
      "Cuenta cuántas veces apareció cada cosa de la segunda lista en tu registro.",
      "Mira las cuentas. Lo que más se repitió es lo primero que hay que atender, y ya no lo vas a poder discutir contigo mismo porque ahí está la cuenta.",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Llénalas con lo que sacaste de los dos ejercicios anteriores: la lista de lo que drena y no devuelve, y lo que se te salió al decirlo en voz alta. En frases cortas, sin explicaciones ni párrafos, para que quepan de un vistazo.",
  ...
  },
  {
    ...
    steps: [
      "Toma una de las cosas que ya pusiste en la columna de lo que se va. Empieza por la que estés listo para cerrar hoy, no por la más grande.",
  ...
  },
  {
    ...
    steps: [
      "Escribe todo lo que sabes hacer: habilidades técnicas, cosas que aprendiste por gusto, oficios raros. No filtres. Si alguien te pagaría por eso o podrías enseñarlo, va en la lista.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Conviértela en una meta de una a tres semanas. Si al leerla piensas «va a estar difícil», hazla más chica. Aquí estás construyendo el hábito de terminar.",
      "Escribe cómo te quieres sentir mientras lo haces. Una palabra basta.",
      "Anota cuántos días por semana puedes dedicarle de verdad sin tirar los otros platos. Considera trabajo, familia y descanso. Si sale menos de lo que quisieras, ese es el número bueno.",
  ...
  },
  {
    ...
    needs: "Tu registro del miniviaje de la última semana.",
    steps: [
      "Reúne lo que anotaste cada día sobre tu miniviaje.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Llénalas sin justificarte: avances en la primera, tropiezos en la segunda y emociones reales en la tercera, aunque no cuadren con los resultados.",
