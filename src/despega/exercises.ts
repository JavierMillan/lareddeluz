/**
 * Los 20 ejercicios del Cuaderno de Trabajo de DESPEGA 3.0.
 *
 * Texto tomado del workbook publicado — no se reescribe aqui. La pagina
 * es el indice; el cuaderno es la fuente. Cada ejercicio conserva su
...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Encuentra la conclusión que sacaste",
      "Ve dónde te ha servido",
  ...
  },
  {
    ...
    steps: [
      "Durante un día completo, pon atención a lo que contestas en automático. Sobre todo cuando te agradecen, cuando",
      "Elige una sola. La que más digas y que, ya vista de frente, no te represente.",
      "Pregúntate qué historia está contando esa frase de ti. No lo que quieres decir, sino lo que literalmente dice. \"Por",
      "Escoge con qué la vas a reemplazar y decídelo ahorita, no en el momento, porque en el momento va a ganar la",
  ...
  },
  {
    ...
    steps: [
      "Grábate dos o tres minutos hablando de algo que te importe. Puede ser contándole a la cámara un proyecto que",
      "Déjalo reposar unas horas, o mejor hasta el día siguiente. Si te ves inmediatamente vas a estar demasiado metido",
      "Escucha solo el audio, sin ver la pantalla. Pon atención a tu tono, a tus muletillas, a las veces que te disculpas o te",
      "Ahora mira solo el video, con el volumen en cero. Fíjate en tus manos, en tu postura, en tu cara. ¿Estás encogido?",
  ...
  },
  {
    ...
    steps: [
      "Siéntate con la espalda derecha, sin ponerte rígido. Puedes cerrar los ojos o dejarlos entreabiertos mirando un",
      "Prueba la primera: inhala contando cuatro, retén cuatro, exhala contando ocho. Hazla cinco veces seguidas y fíjate",
      "Ahora prueba la de caja: inhala cuatro, retén cuatro, exhala cuatro, y antes de volver a inhalar espera otros cuatro.",
      "Prueba la tercera: inhala rápido por la nariz, retén todo lo que aguantes cómodamente, y suelta el aire despacio,",
      "Quédate con la que te dejó más tranquilo. No la que te pareció más interesante ni la que suene más avanzada: la",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Cada noche anota lo que hiciste ese día en la columna que le toque, con la hora aproximada. No lo pienses mucho,",
      "Al terminar la semana, míralas juntas. La pregunta no es cuánto te drenó, es si hubo algo que te recargara y",
      "Si la columna de la derecha está vacía o casi, ahí está tu respuesta. Y no necesitas rediseñar tu vida: mete una sola",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Ahora separa lo que te drena en dos grupos. En uno pon lo que drena pero sí te devuelve algo: el gimnasio, una",
      "En el otro pon lo que drena y no te devuelve nada. Aquí es donde tienes que ser honesto. La reunión a la que vas",
      "Durante dos semanas, cada vez que algo de esa segunda lista te vuelva a drenar, ponle una palomita al lado.",
      "A las dos semanas mira las palomitas. Lo que tenga más es lo que primero hay que atender, y ya no lo vas a poder",
    ],
  ...
  },
  {
    ...
    steps: [
      "Elige a alguien que te escuche sin salir corriendo a darte consejos. No necesitas que te resuelva nada, necesitas",
      "Dile de qué se trata antes de empezar. Algo así: \"quiero contarte algo que estoy pensando soltar y nada más quiero",
      "Cuéntale lo que traes de tu lista y por qué crees que ya no te corresponde. Habla de corrido, sin editarte.",
      "Pon atención a un momento específico: cuando te oigas justificando por qué todavía no lo sueltas. Ahí, en esa",
  ...
  },
  {
    ...
    steps: [
      ...
      "Escríbele lo que te dio. En serio, hazlo: qué te dio esa amistad, ese trabajo, esa versión tuya, ese hábito. Todo lo",
      "Escribe por qué ya no te corresponde. Sin culpar a nadie y sin culparte tú. No tiene que haber un villano, las cosas",
      "Escribe qué te llevas. Siempre queda algo: un aprendizaje, una habilidad, un recuerdo bueno. Eso no se suelta.",
      "Ciérralo con una frase tuya. Puede ser tan simple como \"gracias, ya no te necesito para donde voy\". Léela en voz",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Llénalas con lo que sacaste de los ejercicios anteriores. En frases cortas, sin explicaciones ni párrafos, para que",
  ...
  },
  {
    ...
    steps: [
      "Escribe en primera persona, empezando cada frase con \"soy\". No pongas \"quiero ser\" ni \"algún día seré\", porque",
      "No te limites. Escribe la versión más completa que puedas imaginar, sin preguntarte todavía si es alcanzable. Eso",
      "Cuando termines, cuenta cuántas de esas frases hablan de ti y cuántas de lo que le das a otros. Ese balance te dice",
      "Búscale nombre. Puede ser un apodo que ya te dicen, un diminutivo, o algo que te inventes. Lo importante es que",
    ],
  ...
  },
  {
    ...
    steps: [
      "Toma cada frase de tu súper tú y pregúntate qué necesita esa persona para ser así. Desglósalo en cuatro cosas:",
      "Marca lo que ya tienes. Vas a encontrar más de lo que crees, y eso va directo a la columna de lo que se queda de tu",
      "Marca lo que te falta pero sabes cómo conseguir. Eso ya es tarea, no misterio.",
      "Marca lo que te falta y no tienes idea de cómo se consigue. Sepáralo, porque eso es justo lo que vamos a planear en",
  ...
  },
  {
    ...
    steps: [
      "Escribe todo lo que sabes hacer. Todo. Habilidades técnicas, cosas que aprendiste por gusto, oficios raros, lo que",
      "Ahora busca parentescos. Ve cuáles de esas habilidades se podrían usar juntas en un mismo trabajo o proyecto.",
      "Ponle nombre al grupo más grande. ¿En qué campo caben la mayoría? Ese nombre es tu territorio y",
      "Ahora aterrízalo con estas preguntas: ¿dónde se usa eso? ¿A quién le sirve? ¿Alguien te contrataría por eso? Si no",
      "Escríbelo en una sola frase, empezando con \"yo ayudo a\". Y tiene que ser una frase que puedas decir en voz alta",
    ],
  ...
  },
  {
    ...
    steps: [
      "Regresa a tu lista de la brecha, a lo que te falta para ser tu súper tú. De ahí elige una sola cosa, y elige de las que ya",
      "Conviértela en una meta que quepa en una a tres semanas. Aplícale la prueba: si al leerla piensas \"esto lo puedo",
      "Escribe cómo te quieres sentir mientras lo haces. Una palabra basta.",
      "Ahora la parte incómoda: cuántos días a la semana le puedes dedicar de verdad, sin que se te caigan los otros",
      "Ponle fecha de revisión y anótala en tu calendario, como si fuera una cita con alguien más. Porque lo es.",
      "Junta todo en una frase: \"Durante las próximas [X semanas] voy a [meta], sintiendo [emoción], dedicándole [X",
      "Léela en voz alta y pregúntate si es honesta y sostenible. Si algo te suena forzado, ajústalo ahorita y no a la mitad",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "A cada cosa ponle puntos. Uno si te salió natural, dos si te costó concentración, tres si tuviste que vencerte a ti",
      "Al final de la semana suma. Vas a descubrir semanas de pocos pendientes con muchísimos puntos, y ahí está la",
      "Fíjate en qué tareas te dan siempre tres puntos. Esas son las que hay que repartir, no acumular. Si tu semana trae",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Contesta tres preguntas, en este orden y sin adornar: ¿qué me está costando sostener esta semana? ¿Qué puedo",
  ...
  },
  {
    ...
    steps: [
      ...
      "Llénalas sin justificarte y sin adornar. En la primera van los avances, aunque sean chiquitos, sobre todo los",
      "De la segunda columna saca máximo dos ajustes concretos para el siguiente miniviaje. Dos, no diez.",
      "Y antes de cerrar el cuaderno, escribe una cosa por la que estés agradecido de ese tramo. Suena cursi, ya sé. Hazlo",
    ],
  ...
  },
  {
    ...
    steps: [
      "Elige tu momento y que sea siempre el mismo. Antes de dormir, en la ducha, mientras te tomas el café, caminando.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Haz tres columnas. En la primera escribe qué le estás metiendo: horas por semana, dinero, energía mental,",
      "En la segunda, qué te está devolviendo. Dinero, aprendizaje, satisfacción, contactos, salud. Otra vez concreto, nada",
      "En la tercera, parte esa área en pedazos. Si es tu trabajo, no escribas \"mi trabajo\": escribe las juntas, el código, el",
      "Ahora califica cada pieza por separado. ¿Cuáles están bien y cuáles están podridas? Vas a descubrir, casi siempre,",
      "Pregúntate por esas dos o tres: ¿se pueden cambiar, delegar, reducir o negociar? Si la respuesta es sí en al menos",
    ],
  ...
  },
  {
    ...
    signal: "Cuando puedas explicarle tu decisión a alguien en dos minutos sin ponerte a la defensiva. Si necesitas justificarte mucho, todavía estás decidiendo desde la segunda columna. CRECE · VERSIÓN DE BOLSILLO PARA RECORTAR El método CRECE DESPEGA es para la vida: semanas o meses, con libreta y tiempo. CRECE es para el momento, cuando algo te agarra desprevenido y necesitas volver al presente antes de decidir. El punto es memorizarlo, porque el día que lo necesitas no vas a poder consultar nada. LA FRASE QUE LO DISPARA \"Esta situación me está pidiendo crecer.\" DÓNDE LA VAS A PEGAR",
  },
];
